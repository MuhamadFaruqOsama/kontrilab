...
import { Search01Icon, Notification03Icon, PlusSignIcon } from "@hugeicons/core-free-icons";
  ...
  return (
    <div className="flex w-full items-center justify-between">
      ...
      <div className="flex items-center gap-4 ml-4">
        <button className="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-4 h-10 text-sm font-medium text-white hover:bg-primary/90 transition-colors">
