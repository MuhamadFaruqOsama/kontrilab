            ...
            <Card className="rounded-[18px] border border-ktr-border-light bg-white">
              ...
              <Card.Content className="p-5">
                ...
                <button
                  ...
                  className="mt-4 inline-flex h-10 w-full items-center justify-center gap-2 rounded-[10px] bg-ktr-primary px-4 text-sm font-semibold text-white transition-colors hover:bg-ktr-primary-hover disabled:cursor-not-allowed disabled:opacity-50"
                >
